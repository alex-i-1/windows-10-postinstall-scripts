rem @echo off
rem a harmless command to check the privileges
NET FILE 1>NUL 2>NUL
if '%errorlevel%' == '0' ( goto got_privileges )
rem we don't call any scripts to elevate the privileges, but just exit, - our job for this moment is done
echo need administrator priveleges to run
pause
exit
